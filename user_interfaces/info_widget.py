...
class InfoWidget(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None, defaults=None):
        ...
        self.experiment_name_edit = QtWidgets.QLineEdit('%s' % defaults[1][0], self)
        ...
        self.experiment_date_edit = QtWidgets.QLineEdit('%s' % defaults[2][0], self)
        ...
        self.film_id_edit = QtWidgets.QLineEdit('%s' % defaults[3][0], self)
        ...
        self.film_date_edit = QtWidgets.QLineEdit('%s' % defaults[4][0], self)
        ...
        self.film_thickness_edit = QtWidgets.QLineEdit('%s' % defaults[5][0], self)
        ...
        self.film_area_edit = QtWidgets.QLineEdit('%s' % defaults[6][0], self)
        ...
        self.film_matrix_edit = QtWidgets.QLineEdit('%s' % defaults[7][0], self)
        ...
        self.film_qds_edit = QtWidgets.QLineEdit('%s' % defaults[8][0], self)
        ...
        self.film_qd_concentration_edit = QtWidgets.QLineEdit('%s' % defaults[9][0], self)
        ...
        self.film_qd_emission_edit = QtWidgets.QLineEdit('%s' % defaults[10][0], self)
        ...
        self.film_solvent_edit = QtWidgets.QLineEdit('%s' % defaults[11][0], self)
        ...
        self.pv_cell_id_edit = QtWidgets.QLineEdit('%s' % defaults[12][0], self)
        ...
        self.pv_cell_type_edit = QtWidgets.QLineEdit('%s' % defaults[13][0], self)
        ...
        self.pv_cell_area_edit = QtWidgets.QLineEdit('%s' % defaults[14][0], self)
        ...
        self.setup_location_edit = QtWidgets.QLineEdit('%s' % defaults[15][0], self)
        ...
        self.setup_calibrated_edit = QtWidgets.QLineEdit('%s' % defaults[16][0], self)
        ...
        self.setup_suns_edit = QtWidgets.QLineEdit('%s' % defaults[17][0], self)
        ...
        self.setup_pid_setpoint_edit = QtWidgets.QLineEdit('%s' % defaults[18][0], self)
        ...
        self.room_temperature_edit = QtWidgets.QLineEdit('%s' % defaults[19][0], self)
        ...
        self.room_humidity_edit = QtWidgets.QLineEdit('%s' % defaults[20][0], self)
    ...
    def accept(self):
        self.info[1:] = [[self.experiment_name_edit.text()], [self.experiment_date_edit.text()],
