...
class InfoWidget(QtWidgets.QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.film_date_edit = QtWidgets.QLineEdit('%s' % defaults['info'][3][0], self)
        ...
        self.film_thickness_edit = QtWidgets.QLineEdit('%s' % defaults['info'][4][0], self)
        ...
        self.film_area_edit = QtWidgets.QLineEdit('%s' % defaults['info'][5][0], self)
        ...
        self.film_matrix_edit = QtWidgets.QLineEdit('%s' % defaults['info'][6][0], self)
        ...
        self.film_qds_edit = QtWidgets.QLineEdit('%s' % defaults['info'][7][0], self)
        ...
        self.film_qd_concentration_edit = QtWidgets.QLineEdit('%s' % defaults['info'][8][0], self)
        ...
        self.film_qd_emission_edit = QtWidgets.QLineEdit('%s' % defaults['info'][9][0], self)
        ...
        self.film_solvent_edit = QtWidgets.QLineEdit('%s' % defaults['info'][10][0], self)
        ...
        self.pv_cell_id_edit = QtWidgets.QLineEdit('%s' % defaults['info'][11][0], self)
        ...
        self.pv_cell_type_edit = QtWidgets.QLineEdit('%s' % defaults['info'][12][0], self)
        ...
        self.pv_cell_area_edit = QtWidgets.QLineEdit('%s' % defaults['info'][13][0], self)
        ...
        self.setup_location_edit = QtWidgets.QLineEdit('%s' % defaults['info'][14][0], self)
        ...
        self.setup_calibrated_edit = QtWidgets.QLineEdit('%s' % defaults['info'][15][0], self)
        ...
        self.setup_suns_edit = QtWidgets.QLineEdit('%s' % defaults['info'][16][0], self)
        ...
        self.setup_pid_setpoint_edit = QtWidgets.QLineEdit('%s' % defaults['info'][17][0], self)
        ...
        self.room_temperature_edit = QtWidgets.QLineEdit('%s' % defaults['info'][18][0], self)
        ...
        self.room_humidity_edit = QtWidgets.QLineEdit('%s' % defaults['info'][19][0], self)
